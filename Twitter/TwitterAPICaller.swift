...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "J93oDZa4TpdIUUcHvZi6F3ddb", consumerSecret: "KqbboxRH7iPNyP2G6NOXyhl1dDAvsLh8Wnr7PE4QDhiVYJlJGu")
    var loginSuccess: (() -> ())?
    ...
    func getDictionaryNoParameters(url: String, parameters: Any?,success:@escaping(NSDictionary)->(),failure:@escaping(Error)->()){
